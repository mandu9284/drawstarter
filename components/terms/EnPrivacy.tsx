const EnPrivacy = () => {
  return (
    <div className='prose-sm prose-stone'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to drawstarter.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to drawstarter, accessible from
            drawstarter.com
          </p>
        </li>
        <li>
          <p>
            <strong>You</strong> means the individual access or using the
            Service, or the company, or other legal entity on behalf of which
            such individual is access or using the Service, as applicable.
          </p>
        </li>
      </ul>
      ...
      <ul>
        <li>By email: mandu9284@gmail.com</li>
      </ul>
    </div>
  )
}
